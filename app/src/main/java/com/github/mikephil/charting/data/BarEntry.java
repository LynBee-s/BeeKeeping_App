...
import com.example.lb_app.Hives;
...
public class BarEntry extends Entry {
    ...
    public BarEntry(int i, String[] arrStr) {
    }


    public BarEntry(String descripcion, String total) {
    }

    public BarEntry(int i) {
    }

    public BarEntry(int i, List<Hives> vntas) {
    }
